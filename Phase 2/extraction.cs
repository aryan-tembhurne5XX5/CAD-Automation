...
namespace InventorAssemblyExporter
{
    class Program
    {
        ...
        {
            string assemblyPath = @"E:\Phase 1\Assembly 2\1625891052.iam";
            string outputPath = @"E:\Phase 1\Assembly 2\assembly2_full_export.json";
            ...
            AssemblyDocument asmDoc = (AssemblyDocument)invApp.Documents.Open(assemblyPath, true);
